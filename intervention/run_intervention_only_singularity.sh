...
# Concept Interventions Only - Singularity Execution Script
...
OUTPUT_PATH="/analysis/minotaur/intervention_results.pkl"
...
echo "Running Concept Interventions..."
echo "Model: $MODEL_PATH"
echo "Test Data: $TEST_DATA"
echo "Output: $OUTPUT_PATH"
echo ""

# Run concept interventions in Singularity container
singularity exec --nv \
    ...
    python /scripts/MINOTAUR/intervention/concept_intervention.py \
...
echo "Concept interventions completed!"
